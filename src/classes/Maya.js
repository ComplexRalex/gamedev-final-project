        ...
        if (!noEnemies) {
            ...
            if (!this.hasAlreadyTalked) {
                this.dialogs = [
                    ...
                    { who: 'maya', what: 'Tuve un enfrentamiento contra un chivo que se hace llamar Barry.', forward: false },
                    ...
                    { who: 'maya', what: 'Ahí es cuando lo vi.', forward: false },
                    { who: 'nor', what: '¿Y qué sucedió?', forward: true },
                    { who: 'maya', what: 'Estaba hablando con palabras que nunca antes había escuchado... es como si fuera un ser de otro planeta.', forward: false },
                    ...
                    { who: 'maya', what: 'No es tan simple como parece, Nor...', forward: false },
